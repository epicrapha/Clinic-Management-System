<div class="aside-menu-container" id="sidebar">
    <div class="aside-menu-container__aside-logo flex-column-auto">
        <a href="{{ url('/') }}" class="text-decoration-none sidebar-logo" data-turbo="false" target="_blank">
            <img src="{{ getAppLogo() }}" alt="Logo" class="object-cover sidebar-app-logo" />
        </a>
    ...
    <form class="d-flex position-relative aside-menu-container__aside-search search-control py-3 mt-1">
        <div class="position-relative w-100">
            <input class="form-control" type="text" placeholder="{{ __('messages.common.search') }}" aria-label="Search"
                id="menuSearch">
