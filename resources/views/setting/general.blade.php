                            ...
                            <div class="d-block">
                                <div class="image-picker">
                                    <div class="image previewImage" id="appLogoPreview"
                                         style="background-image: url('{{ ($setting['logo']) ? (filter_var($setting['logo'], FILTER_VALIDATE_URL) ? $setting['logo'] : asset($setting['logo'])) : asset('assets/image/infyCare-favicon.ico') }}')">
                                    </div>
                            ...
                            <div class="d-block">
                                <div class="image-picker">
                                    <div class="image previewImage" id="faviconPreview"
                                         style="background-image: url('{{ ($setting['favicon']) ? (filter_var($setting['favicon'], FILTER_VALIDATE_URL) ? $setting['favicon'] : asset($setting['favicon'])) : asset('assets/image/infyom-logo.png') }}');">
                                    </div>
